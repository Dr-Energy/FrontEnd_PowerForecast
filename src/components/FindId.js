          ...
          <div className="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
            <table className="min-w-full divide-y divide-gray-300">
              <tbody className="divide-y divide-gray-200">
                  ...
                  <tr>
                    <td className="text-left px-4 py-2 text-white">회원정보에 등록한 전화번호로 인증하기</td>
                  </tr>
                  <tr>
                    <input type='text' className="whitespace-nowrap px-5 py-4 text-sm text-white bg-white bg-transparent placeholder-white" placeholder='전화번호를 입력하세요.'/>
                </tr>
              </tbody>
            </table>
